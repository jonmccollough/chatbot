...
INSERT INTO keywords (words, keywordid) VALUES ('job search', (SELECT id FROM responses WHERE title = 'job search'));
...
INSERT INTO keywords (words, keywordid) VALUES ('cover letter', (SELECT id FROM responses WHERE title = 'cover letter'));
...
INSERT INTO keywords (words, keywordid) VALUES ('star questions', (SELECT id FROM responses WHERE title = 'star questions'));
